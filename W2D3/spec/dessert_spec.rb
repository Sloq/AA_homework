...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    it "sets a quantity" do
      expect(dessert.quantity).to be(5)
    end
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect { Dessert.new("cake", five, chef) }.to raise_error
    end
  end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["vodka", "rum", "absinthe", "sugar", "butter"]
  ...
  describe "#eat" do
    ...
    it "raises an error if the amount is greater than the quantity" do
      expect { dessert.eat(99) }.to raise_error("not enough left!")
    end
  end
